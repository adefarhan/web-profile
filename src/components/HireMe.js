...
const HireMe = () => {
  return (
    <div className="fixed left-4 bottom-1 flex items-center justify-center overflow-hidden md:right-0 md:left-auto md:top-0 md:bottom-auto md:absolute">
      <div className="w-56 h-auto flex items-center justify-center relative md:w-36">
        <JobLogo className="fill-dark animate-spin-slow dark:fill-light" />
        <Link
