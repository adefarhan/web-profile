  ...
  return (
    <article className="w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative dark:bg-dark dark:border-light xs:p-4">
      ...
      <div className="w-full flex flex-col items-start justify-between mt-4">
        ...
        <p className="my-2 font-medium text-dark dark:text-light lg:text-sm">
          {summary}
        </p>
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                summary="A beautiful and elegant wedding invitation website, theme magazine, RSVP"
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                img={serviceAC}
                title="Service AC"
                summary="Website profile and booking service for AC maintenance business, built to simplify customer inquiries and service scheduling."
                link="https://sinarmulyajaya.my.id"
                type="NextJS & Go Project"
                github="https://github.com/adefarhan"
              />
            </div>
