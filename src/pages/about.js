...
const About = () => {
  ...
  useEffect(() => {
    ...
    setYearsOfExperience(years.toFixed(1)); // 1 angka desimal
  }, []);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Ade Farhan About Page, About Ade Farhan" />
      </Head>
      ...
      <main className="flex w-full flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          <AnimatedText text="Relentless Dedication" className="mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl sm:mb-8" />
